...
# 
    ...
    #command2 = 'oarsub --project iste-equ-cycle -l /nodes=1/core=1,walltime=01:00:00 -d ' + workingDir , "".join("iw"+str(request.json['subSwath']))) + ' "nsb_getListInterfero.py nsbas.proc" |grep OAR_JOB_ID |cut -d "=" -f 2'
