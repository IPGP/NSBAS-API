...
Note PHA 20170418 : Code dérivé du modèle asynchrone ws_coregListInterf en vue du codage fina
"""
import os
import logging
...
wsPortNumber = int(config['ws_compInterf_PN'])
...
#
    ...
    if request.values['mode'] == "async" :
        ...
        process_ressources = {"nodes" : 1, "cores" : 4, "walltime" : "01:50:00", "workdir": token_dir}
        ...
        command = " " .join(["nsb_gen_phase.mpi", "nsbas.proc"])
        try:
